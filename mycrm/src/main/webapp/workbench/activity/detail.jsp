...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // ---给活动备注的编辑和修改按钮动态绑定事件(仅为鼠标移入移出效果)---
            ...
            $("#updateRemarkBtn").click(function () {
                var id = $("#remarkId").val();
                var notContent = $("#noteContent").val();
                $.ajax({
                    url: "workbench/activity/updateRemark.do",
                    data: {
                        id: id,
                        noteContent: $.trim(notContent)
                    },
                    type: "post",
                    dataType: "json",
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b>'; // 在js中的el表达式必须套在引号内
